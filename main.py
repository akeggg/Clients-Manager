...
class MainWindow(QMainWindow):
    def __init__(self, *args, **kwargs):
        ...
        self.masterBtn = QPushButton("Мастера", self.centralWidget)
        self.serviceBtn = QPushButton("Услуги", self.centralWidget)
        self.clientBtn = QPushButton("Новый клиент", self.centralWidget)
        ...
        self.model.setHeaderData(1, Qt.Horizontal, "Время")
        self.model.setHeaderData(2, Qt.Horizontal, "Мастер")
        self.model.setHeaderData(3, Qt.Horizontal, "Услуга")
        self.model.setHeaderData(4, Qt.Horizontal, "Имя клиента")
        self.model.setHeaderData(5, Qt.Horizontal, "Контактный номер")
